...
adminRouter.get('/unverified', verifyAuthToken, verifyRole(admin), getUnverifiedMangers);
adminRouter.get('/all', verifyAuthToken, verifyRole(admin), getAllUsers);
adminRouter.put('/verify/:manager_id', verifyAuthToken, verifyRole(admin), verifyManager);
adminRouter.delete('/delete/:user_id', verifyAuthToken, verifyRole(admin), deleteUser);
